...
import { EventContext, BidContext, ItemsContext } from "../pages/AuctionRoom";
...
const ItemDetails = (props) => {
  ...
  const itemSold = () => {
    ...
    if (
      ...
      toast({
        title: "Item sold!",
        description: `Buyer: ${props.recentBid.by}, Amount: ${props.recentBid.amount}`,
        status: "success",
        duration: 5000,
        isClosable: true,
      });
      if (currentItem.id === items[items.length - 1].id) {
        navigate("/allevents");
      }
    }
  };
